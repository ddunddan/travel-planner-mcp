...
| 🏨 **숙소 예약** | 국내: 야놀자, 여기어때 / 해외: Booking, Expedia |
| 📍 **장소 검색** | 카카오맵 기반 관광지/맛집/카페 추천 (국내) |
| 🗺️ **일정 생성** | 카카오모빌리티 API 기반 실제 이동 시간 30분 이내 동선 최적화 |
...
### 4. `plan_trip` - 종합 여행 일정 (국내 전용)

**카카오모빌리티 API 기반 실제 이동 시간 30분 이내 동선 최적화**
...
| `transport` | ❌ | car | car(자차/렌트카)/public(대중교통) |
| `themes` | ❌ | - | 테마 리스트 (["맛집", "자연", "카페"]) |
| `adults` | ❌ | 2 | 인원 수 |

**특징:**
- 🗺️ 카카오모빌리티 길찾기 API로 실제 이동 시간 계산
- ⏱️ 같은 날 일정은 이동 30분 이내로 자동 구성
- 🚗 각 장소 간 카카오맵 길찾기 링크 제공
- 🚫 중복 장소 자동 제외
...
| 기능 | 설명 |
|------|------|
| 📍 **숙소 기반 동선** | 숙소 위치를 고려한 효율적인 동선 추천 |
| 💬 **카카오톡 공유** | 일정을 카카오톡 나에게 보내기 |
| 📅 **캘린더 연동** | 카카오 캘린더 일정 자동 등록 |
| 🌏 **해외 관광정보** | 해외 여행지 관광지/맛집 검색 |
